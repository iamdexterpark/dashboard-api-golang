...
func (o *GetNetworkCellularGatewayConnectivityMonitoringDestinationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkCellularGatewayConnectivityMonitoringDestinationsOK()
...
func NewGetNetworkCellularGatewayConnectivityMonitoringDestinationsOK() *GetNetworkCellularGatewayConnectivityMonitoringDestinationsOK {
	return &GetNetworkCellularGatewayConnectivityMonitoringDestinationsOK{}
}
...
func (o *GetNetworkCellularGatewayConnectivityMonitoringDestinationsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/cellularGateway/connectivityMonitoringDestinations][%d] getNetworkCellularGatewayConnectivityMonitoringDestinationsOK  %+v", 200, o.Payload)
}
func (o *GetNetworkCellularGatewayConnectivityMonitoringDestinationsOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkCellularGatewayConnectivityMonitoringDestinationsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
