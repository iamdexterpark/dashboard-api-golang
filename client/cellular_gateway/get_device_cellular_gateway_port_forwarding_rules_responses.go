...
func (o *GetDeviceCellularGatewayPortForwardingRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetDeviceCellularGatewayPortForwardingRulesOK()
...
func NewGetDeviceCellularGatewayPortForwardingRulesOK() *GetDeviceCellularGatewayPortForwardingRulesOK {
	return &GetDeviceCellularGatewayPortForwardingRulesOK{}
}
...
func (o *GetDeviceCellularGatewayPortForwardingRulesOK) Error() string {
	return fmt.Sprintf("[GET /devices/{serial}/cellularGateway/portForwardingRules][%d] getDeviceCellularGatewayPortForwardingRulesOK  %+v", 200, o.Payload)
}
func (o *GetDeviceCellularGatewayPortForwardingRulesOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetDeviceCellularGatewayPortForwardingRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
