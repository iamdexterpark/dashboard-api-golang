...
func (o *GetDeviceLossAndLatencyHistoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetDeviceLossAndLatencyHistoryOK()
...
func NewGetDeviceLossAndLatencyHistoryOK() *GetDeviceLossAndLatencyHistoryOK {
	return &GetDeviceLossAndLatencyHistoryOK{}
}
...
func (o *GetDeviceLossAndLatencyHistoryOK) Error() string {
	return fmt.Sprintf("[GET /devices/{serial}/lossAndLatencyHistory][%d] getDeviceLossAndLatencyHistoryOK  %+v", 200, o.Payload)
}
func (o *GetDeviceLossAndLatencyHistoryOK) GetPayload() []interface{} {
	return o.Payload
}

func (o *GetDeviceLossAndLatencyHistoryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
