...
func (o *UpdateDeviceCameraVideoSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateDeviceCameraVideoSettingsOK()
...
func (o *UpdateDeviceCameraVideoSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateDeviceCameraVideoSettingsBody) UnmarshalBinary(b []byte) error {
	var res UpdateDeviceCameraVideoSettingsBody
