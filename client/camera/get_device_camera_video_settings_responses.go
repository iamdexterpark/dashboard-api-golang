...
func (o *GetDeviceCameraVideoSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetDeviceCameraVideoSettingsOK()
...
func NewGetDeviceCameraVideoSettingsOK() *GetDeviceCameraVideoSettingsOK {
	return &GetDeviceCameraVideoSettingsOK{}
}
...
func (o *GetDeviceCameraVideoSettingsOK) Error() string {
	return fmt.Sprintf("[GET /devices/{serial}/camera/video/settings][%d] getDeviceCameraVideoSettingsOK  %+v", 200, o.Payload)
}
func (o *GetDeviceCameraVideoSettingsOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetDeviceCameraVideoSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
