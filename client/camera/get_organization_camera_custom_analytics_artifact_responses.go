...
func (o *GetOrganizationCameraCustomAnalyticsArtifactReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetOrganizationCameraCustomAnalyticsArtifactOK()
...
func NewGetOrganizationCameraCustomAnalyticsArtifactOK() *GetOrganizationCameraCustomAnalyticsArtifactOK {
	return &GetOrganizationCameraCustomAnalyticsArtifactOK{}
}
...
func (o *GetOrganizationCameraCustomAnalyticsArtifactOK) Error() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/camera/customAnalytics/artifacts/{artifactId}][%d] getOrganizationCameraCustomAnalyticsArtifactOK  %+v", 200, o.Payload)
}
func (o *GetOrganizationCameraCustomAnalyticsArtifactOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetOrganizationCameraCustomAnalyticsArtifactOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
