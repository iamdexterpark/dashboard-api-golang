...
func (o *GetDeviceCameraCustomAnalyticsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetDeviceCameraCustomAnalyticsOK()
...
func NewGetDeviceCameraCustomAnalyticsOK() *GetDeviceCameraCustomAnalyticsOK {
	return &GetDeviceCameraCustomAnalyticsOK{}
}
...
func (o *GetDeviceCameraCustomAnalyticsOK) Error() string {
	return fmt.Sprintf("[GET /devices/{serial}/camera/customAnalytics][%d] getDeviceCameraCustomAnalyticsOK  %+v", 200, o.Payload)
}
func (o *GetDeviceCameraCustomAnalyticsOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetDeviceCameraCustomAnalyticsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
