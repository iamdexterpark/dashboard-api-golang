...
func (o *GetDeviceCameraVideoLinkReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetDeviceCameraVideoLinkOK()
...
func NewGetDeviceCameraVideoLinkOK() *GetDeviceCameraVideoLinkOK {
	return &GetDeviceCameraVideoLinkOK{}
}
...
func (o *GetDeviceCameraVideoLinkOK) Error() string {
	return fmt.Sprintf("[GET /devices/{serial}/camera/videoLink][%d] getDeviceCameraVideoLinkOK  %+v", 200, o.Payload)
}
func (o *GetDeviceCameraVideoLinkOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetDeviceCameraVideoLinkOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
