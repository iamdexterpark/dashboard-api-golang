...
func (o *DeleteNetworkSmUserAccessDeviceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeleteNetworkSmUserAccessDeviceNoContent()
...
func NewDeleteNetworkSmUserAccessDeviceNoContent() *DeleteNetworkSmUserAccessDeviceNoContent {
	return &DeleteNetworkSmUserAccessDeviceNoContent{}
}
...
func (o *DeleteNetworkSmUserAccessDeviceNoContent) Error() string {
	return fmt.Sprintf("[DELETE /networks/{networkId}/sm/userAccessDevices/{userAccessDeviceId}][%d] deleteNetworkSmUserAccessDeviceNoContent ", 204)
}

func (o *DeleteNetworkSmUserAccessDeviceNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
