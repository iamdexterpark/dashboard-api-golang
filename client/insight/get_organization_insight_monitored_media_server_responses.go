...
func (o *GetOrganizationInsightMonitoredMediaServerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetOrganizationInsightMonitoredMediaServerOK()
...
func NewGetOrganizationInsightMonitoredMediaServerOK() *GetOrganizationInsightMonitoredMediaServerOK {
	return &GetOrganizationInsightMonitoredMediaServerOK{}
}
...
func (o *GetOrganizationInsightMonitoredMediaServerOK) Error() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/insight/monitoredMediaServers/{monitoredMediaServerId}][%d] getOrganizationInsightMonitoredMediaServerOK  %+v", 200, o.Payload)
}
func (o *GetOrganizationInsightMonitoredMediaServerOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetOrganizationInsightMonitoredMediaServerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
