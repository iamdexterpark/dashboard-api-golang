...
func (o *GetNetworkApplianceFirewallPortForwardingRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkApplianceFirewallPortForwardingRulesOK()
...
func NewGetNetworkApplianceFirewallPortForwardingRulesOK() *GetNetworkApplianceFirewallPortForwardingRulesOK {
	return &GetNetworkApplianceFirewallPortForwardingRulesOK{}
}
...
func (o *GetNetworkApplianceFirewallPortForwardingRulesOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/appliance/firewall/portForwardingRules][%d] getNetworkApplianceFirewallPortForwardingRulesOK  %+v", 200, o.Payload)
}
func (o *GetNetworkApplianceFirewallPortForwardingRulesOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkApplianceFirewallPortForwardingRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
