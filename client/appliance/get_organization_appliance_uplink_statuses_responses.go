...
func (o *GetOrganizationApplianceUplinkStatusesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetOrganizationApplianceUplinkStatusesOK()
...
func NewGetOrganizationApplianceUplinkStatusesOK() *GetOrganizationApplianceUplinkStatusesOK {
	return &GetOrganizationApplianceUplinkStatusesOK{}
}
...
func (o *GetOrganizationApplianceUplinkStatusesOK) Error() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/appliance/uplink/statuses][%d] getOrganizationApplianceUplinkStatusesOK  %+v", 200, o.Payload)
}
func (o *GetOrganizationApplianceUplinkStatusesOK) GetPayload() []interface{} {
	return o.Payload
}

func (o *GetOrganizationApplianceUplinkStatusesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
