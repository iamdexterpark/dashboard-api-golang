...
func (o *GetNetworkApplianceSecurityEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkApplianceSecurityEventsOK()
...
func NewGetNetworkApplianceSecurityEventsOK() *GetNetworkApplianceSecurityEventsOK {
	return &GetNetworkApplianceSecurityEventsOK{}
}
...
func (o *GetNetworkApplianceSecurityEventsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/appliance/security/events][%d] getNetworkApplianceSecurityEventsOK  %+v", 200, o.Payload)
}
func (o *GetNetworkApplianceSecurityEventsOK) GetPayload() []interface{} {
	return o.Payload
}

func (o *GetNetworkApplianceSecurityEventsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
