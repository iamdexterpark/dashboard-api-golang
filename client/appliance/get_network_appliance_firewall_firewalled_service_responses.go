...
func (o *GetNetworkApplianceFirewallFirewalledServiceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkApplianceFirewallFirewalledServiceOK()
...
func NewGetNetworkApplianceFirewallFirewalledServiceOK() *GetNetworkApplianceFirewallFirewalledServiceOK {
	return &GetNetworkApplianceFirewallFirewalledServiceOK{}
}
...
func (o *GetNetworkApplianceFirewallFirewalledServiceOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/appliance/firewall/firewalledServices/{service}][%d] getNetworkApplianceFirewallFirewalledServiceOK  %+v", 200, o.Payload)
}
func (o *GetNetworkApplianceFirewallFirewalledServiceOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkApplianceFirewallFirewalledServiceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
