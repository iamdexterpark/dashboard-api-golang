...
func (o *GetNetworkApplianceFirewallCellularFirewallRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkApplianceFirewallCellularFirewallRulesOK()
...
func NewGetNetworkApplianceFirewallCellularFirewallRulesOK() *GetNetworkApplianceFirewallCellularFirewallRulesOK {
	return &GetNetworkApplianceFirewallCellularFirewallRulesOK{}
}
...
func (o *GetNetworkApplianceFirewallCellularFirewallRulesOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/appliance/firewall/cellularFirewallRules][%d] getNetworkApplianceFirewallCellularFirewallRulesOK  %+v", 200, o.Payload)
}
func (o *GetNetworkApplianceFirewallCellularFirewallRulesOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkApplianceFirewallCellularFirewallRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
