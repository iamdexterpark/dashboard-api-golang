...
func (o *GetNetworkApplianceTrafficShapingRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkApplianceTrafficShapingRulesOK()
...
func NewGetNetworkApplianceTrafficShapingRulesOK() *GetNetworkApplianceTrafficShapingRulesOK {
	return &GetNetworkApplianceTrafficShapingRulesOK{}
}
...
func (o *GetNetworkApplianceTrafficShapingRulesOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/appliance/trafficShaping/rules][%d] getNetworkApplianceTrafficShapingRulesOK  %+v", 200, o.Payload)
}
func (o *GetNetworkApplianceTrafficShapingRulesOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkApplianceTrafficShapingRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
