...
func (o *GetNetworkApplianceClientSecurityEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkApplianceClientSecurityEventsOK()
...
func (o *GetNetworkApplianceClientSecurityEventsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/appliance/clients/{clientId}/security/events][%d] getNetworkApplianceClientSecurityEventsOK  %+v", 200, o.Payload)
}
func (o *GetNetworkApplianceClientSecurityEventsOK) GetPayload() []interface{} {
	return o.Payload
}

func (o *GetNetworkApplianceClientSecurityEventsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
