...
func (o *GetNetworkApplianceContentFilteringCategoriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkApplianceContentFilteringCategoriesOK()
...
func NewGetNetworkApplianceContentFilteringCategoriesOK() *GetNetworkApplianceContentFilteringCategoriesOK {
	return &GetNetworkApplianceContentFilteringCategoriesOK{}
}
...
func (o *GetNetworkApplianceContentFilteringCategoriesOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/appliance/contentFiltering/categories][%d] getNetworkApplianceContentFilteringCategoriesOK  %+v", 200, o.Payload)
}
func (o *GetNetworkApplianceContentFilteringCategoriesOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkApplianceContentFilteringCategoriesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
