...
func (o *GetNetworkApplianceStaticRoutesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkApplianceStaticRoutesOK()
...
func NewGetNetworkApplianceStaticRoutesOK() *GetNetworkApplianceStaticRoutesOK {
	return &GetNetworkApplianceStaticRoutesOK{}
}
...
func (o *GetNetworkApplianceStaticRoutesOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/appliance/staticRoutes][%d] getNetworkApplianceStaticRoutesOK  %+v", 200, o.Payload)
}
func (o *GetNetworkApplianceStaticRoutesOK) GetPayload() []interface{} {
	return o.Payload
}

func (o *GetNetworkApplianceStaticRoutesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
