...
func (o *GetNetworkApplianceVlansSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkApplianceVlansSettingsOK()
...
func NewGetNetworkApplianceVlansSettingsOK() *GetNetworkApplianceVlansSettingsOK {
	return &GetNetworkApplianceVlansSettingsOK{}
}
...
func (o *GetNetworkApplianceVlansSettingsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/appliance/vlans/settings][%d] getNetworkApplianceVlansSettingsOK  %+v", 200, o.Payload)
}
func (o *GetNetworkApplianceVlansSettingsOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkApplianceVlansSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
