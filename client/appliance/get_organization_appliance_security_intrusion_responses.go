...
func (o *GetOrganizationApplianceSecurityIntrusionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetOrganizationApplianceSecurityIntrusionOK()
...
func NewGetOrganizationApplianceSecurityIntrusionOK() *GetOrganizationApplianceSecurityIntrusionOK {
	return &GetOrganizationApplianceSecurityIntrusionOK{}
}
...
func (o *GetOrganizationApplianceSecurityIntrusionOK) Error() string {
	return fmt.Sprintf("[GET /organizations/{organizationId}/appliance/security/intrusion][%d] getOrganizationApplianceSecurityIntrusionOK  %+v", 200, o.Payload)
}
func (o *GetOrganizationApplianceSecurityIntrusionOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetOrganizationApplianceSecurityIntrusionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
