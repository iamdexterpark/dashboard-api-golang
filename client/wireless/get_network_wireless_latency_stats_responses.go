...
func (o *GetNetworkWirelessLatencyStatsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkWirelessLatencyStatsOK()
...
func NewGetNetworkWirelessLatencyStatsOK() *GetNetworkWirelessLatencyStatsOK {
	return &GetNetworkWirelessLatencyStatsOK{}
}
...
func (o *GetNetworkWirelessLatencyStatsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/latencyStats][%d] getNetworkWirelessLatencyStatsOK  %+v", 200, o.Payload)
}
func (o *GetNetworkWirelessLatencyStatsOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkWirelessLatencyStatsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
