...
func (o *GetNetworkWirelessSsidDeviceTypeGroupPoliciesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkWirelessSsidDeviceTypeGroupPoliciesOK()
...
func NewGetNetworkWirelessSsidDeviceTypeGroupPoliciesOK() *GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK {
	return &GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK{}
}
...
func (o *GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/ssids/{number}/deviceTypeGroupPolicies][%d] getNetworkWirelessSsidDeviceTypeGroupPoliciesOK  %+v", 200, o.Payload)
}
func (o *GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkWirelessSsidDeviceTypeGroupPoliciesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
