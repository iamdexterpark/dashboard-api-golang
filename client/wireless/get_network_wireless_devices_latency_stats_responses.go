...
func (o *GetNetworkWirelessDevicesLatencyStatsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkWirelessDevicesLatencyStatsOK()
...
func NewGetNetworkWirelessDevicesLatencyStatsOK() *GetNetworkWirelessDevicesLatencyStatsOK {
	return &GetNetworkWirelessDevicesLatencyStatsOK{}
}
...
func (o *GetNetworkWirelessDevicesLatencyStatsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/devices/latencyStats][%d] getNetworkWirelessDevicesLatencyStatsOK  %+v", 200, o.Payload)
}
func (o *GetNetworkWirelessDevicesLatencyStatsOK) GetPayload() []interface{} {
	return o.Payload
}

func (o *GetNetworkWirelessDevicesLatencyStatsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
