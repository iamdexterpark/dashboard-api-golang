...
// NewGetNetworkWirelessLatencyHistoryParams creates a new GetNetworkWirelessLatencyHistoryParams object,
...
func NewGetNetworkWirelessLatencyHistoryParams() *GetNetworkWirelessLatencyHistoryParams {
	return &GetNetworkWirelessLatencyHistoryParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetNetworkWirelessLatencyHistoryParamsWithTimeout creates a new GetNetworkWirelessLatencyHistoryParams object
...
// NewGetNetworkWirelessLatencyHistoryParamsWithContext creates a new GetNetworkWirelessLatencyHistoryParams object
...
// NewGetNetworkWirelessLatencyHistoryParamsWithHTTPClient creates a new GetNetworkWirelessLatencyHistoryParams object
...
func (o *GetNetworkWirelessLatencyHistoryParams) WithDefaults() *GetNetworkWirelessLatencyHistoryParams {
	o.SetDefaults()
	return o
}
...
func (o *GetNetworkWirelessLatencyHistoryParams) WithTimeout(timeout time.Duration) *GetNetworkWirelessLatencyHistoryParams {
...
func (o *GetNetworkWirelessLatencyHistoryParams) WithContext(ctx context.Context) *GetNetworkWirelessLatencyHistoryParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get network wireless latency history params
func (o *GetNetworkWirelessLatencyHistoryParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get network wireless latency history params
func (o *GetNetworkWirelessLatencyHistoryParams) WithHTTPClient(client *http.Client) *GetNetworkWirelessLatencyHistoryParams {
...
func (o *GetNetworkWirelessLatencyHistoryParams) WithAccessCategory(accessCategory *string) *GetNetworkWirelessLatencyHistoryParams {
	o.SetAccessCategory(accessCategory)
	return o
}
...
func (o *GetNetworkWirelessLatencyHistoryParams) SetAccessCategory(accessCategory *string) {
	o.AccessCategory = accessCategory
}

// WithApTag adds the apTag to the get network wireless latency history params
func (o *GetNetworkWirelessLatencyHistoryParams) WithApTag(apTag *string) *GetNetworkWirelessLatencyHistoryParams {
	o.SetApTag(apTag)
	return o
}
...
func (o *GetNetworkWirelessLatencyHistoryParams) WithAutoResolution(autoResolution *bool) *GetNetworkWirelessLatencyHistoryParams {
...
func (o *GetNetworkWirelessLatencyHistoryParams) WithBand(band *string) *GetNetworkWirelessLatencyHistoryParams {
	o.SetBand(band)
	return o
}

// SetBand adds the band to the get network wireless latency history params
func (o *GetNetworkWirelessLatencyHistoryParams) SetBand(band *string) {
	o.Band = band
}

// WithClientID adds the clientID to the get network wireless latency history params
func (o *GetNetworkWirelessLatencyHistoryParams) WithClientID(clientID *string) *GetNetworkWirelessLatencyHistoryParams {
...
func (o *GetNetworkWirelessLatencyHistoryParams) WithDeviceSerial(deviceSerial *string) *GetNetworkWirelessLatencyHistoryParams {
...
func (o *GetNetworkWirelessLatencyHistoryParams) WithNetworkID(networkID string) *GetNetworkWirelessLatencyHistoryParams {
...
func (o *GetNetworkWirelessLatencyHistoryParams) WithResolution(resolution *int64) *GetNetworkWirelessLatencyHistoryParams {
...
func (o *GetNetworkWirelessLatencyHistoryParams) WithSsid(ssid *int64) *GetNetworkWirelessLatencyHistoryParams {
	o.SetSsid(ssid)
	return o
}

// SetSsid adds the ssid to the get network wireless latency history params
func (o *GetNetworkWirelessLatencyHistoryParams) SetSsid(ssid *int64) {
	o.Ssid = ssid
}

// WithT0 adds the t0 to the get network wireless latency history params
func (o *GetNetworkWirelessLatencyHistoryParams) WithT0(t0 *string) *GetNetworkWirelessLatencyHistoryParams {
	o.SetT0(t0)
	return o
}

// SetT0 adds the t0 to the get network wireless latency history params
func (o *GetNetworkWirelessLatencyHistoryParams) SetT0(t0 *string) {
	o.T0 = t0
}

// WithT1 adds the t1 to the get network wireless latency history params
func (o *GetNetworkWirelessLatencyHistoryParams) WithT1(t1 *string) *GetNetworkWirelessLatencyHistoryParams {
	o.SetT1(t1)
	return o
}

// SetT1 adds the t1 to the get network wireless latency history params
func (o *GetNetworkWirelessLatencyHistoryParams) SetT1(t1 *string) {
	o.T1 = t1
}

// WithTimespan adds the timespan to the get network wireless latency history params
func (o *GetNetworkWirelessLatencyHistoryParams) WithTimespan(timespan *float32) *GetNetworkWirelessLatencyHistoryParams {
...
func (o *GetNetworkWirelessLatencyHistoryParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.AccessCategory != nil {

		// query param accessCategory
		var qrAccessCategory string

		if o.AccessCategory != nil {
			qrAccessCategory = *o.AccessCategory
		}
		qAccessCategory := qrAccessCategory
		if qAccessCategory != "" {

			if err := r.SetQueryParam("accessCategory", qAccessCategory); err != nil {
				return err
			}
		}
	}
