...
// NewGetNetworkWirelessClientsConnectionStatsParams creates a new GetNetworkWirelessClientsConnectionStatsParams object,
...
func NewGetNetworkWirelessClientsConnectionStatsParams() *GetNetworkWirelessClientsConnectionStatsParams {
	return &GetNetworkWirelessClientsConnectionStatsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetNetworkWirelessClientsConnectionStatsParamsWithTimeout creates a new GetNetworkWirelessClientsConnectionStatsParams object
...
// NewGetNetworkWirelessClientsConnectionStatsParamsWithContext creates a new GetNetworkWirelessClientsConnectionStatsParams object
...
// NewGetNetworkWirelessClientsConnectionStatsParamsWithHTTPClient creates a new GetNetworkWirelessClientsConnectionStatsParams object
...
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithDefaults() *GetNetworkWirelessClientsConnectionStatsParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetNetworkWirelessClientsConnectionStatsParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithTimeout(timeout time.Duration) *GetNetworkWirelessClientsConnectionStatsParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithContext(ctx context.Context) *GetNetworkWirelessClientsConnectionStatsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithHTTPClient(client *http.Client) *GetNetworkWirelessClientsConnectionStatsParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithApTag adds the apTag to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithApTag(apTag *string) *GetNetworkWirelessClientsConnectionStatsParams {
	o.SetApTag(apTag)
	return o
}

// SetApTag adds the apTag to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) SetApTag(apTag *string) {
	o.ApTag = apTag
}

// WithBand adds the band to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithBand(band *string) *GetNetworkWirelessClientsConnectionStatsParams {
	o.SetBand(band)
	return o
}

// SetBand adds the band to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) SetBand(band *string) {
	o.Band = band
}

// WithNetworkID adds the networkID to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithNetworkID(networkID string) *GetNetworkWirelessClientsConnectionStatsParams {
...
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithSsid(ssid *int64) *GetNetworkWirelessClientsConnectionStatsParams {
	o.SetSsid(ssid)
	return o
}

// SetSsid adds the ssid to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) SetSsid(ssid *int64) {
	o.Ssid = ssid
}

// WithT0 adds the t0 to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithT0(t0 *string) *GetNetworkWirelessClientsConnectionStatsParams {
	o.SetT0(t0)
	return o
}

// SetT0 adds the t0 to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) SetT0(t0 *string) {
	o.T0 = t0
}

// WithT1 adds the t1 to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithT1(t1 *string) *GetNetworkWirelessClientsConnectionStatsParams {
	o.SetT1(t1)
	return o
}

// SetT1 adds the t1 to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) SetT1(t1 *string) {
	o.T1 = t1
}

// WithTimespan adds the timespan to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithTimespan(timespan *float32) *GetNetworkWirelessClientsConnectionStatsParams {
...
func (o *GetNetworkWirelessClientsConnectionStatsParams) WithVlan(vlan *int64) *GetNetworkWirelessClientsConnectionStatsParams {
	o.SetVlan(vlan)
	return o
}

// SetVlan adds the vlan to the get network wireless clients connection stats params
func (o *GetNetworkWirelessClientsConnectionStatsParams) SetVlan(vlan *int64) {
	o.Vlan = vlan
}

// WriteToRequest writes these params to a swagger request
func (o *GetNetworkWirelessClientsConnectionStatsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
