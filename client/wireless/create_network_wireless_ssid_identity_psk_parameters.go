...
// NewCreateNetworkWirelessSsidIdentityPskParams creates a new CreateNetworkWirelessSsidIdentityPskParams object,
...
func NewCreateNetworkWirelessSsidIdentityPskParams() *CreateNetworkWirelessSsidIdentityPskParams {
	return &CreateNetworkWirelessSsidIdentityPskParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCreateNetworkWirelessSsidIdentityPskParamsWithTimeout creates a new CreateNetworkWirelessSsidIdentityPskParams object
...
// NewCreateNetworkWirelessSsidIdentityPskParamsWithContext creates a new CreateNetworkWirelessSsidIdentityPskParams object
...
// NewCreateNetworkWirelessSsidIdentityPskParamsWithHTTPClient creates a new CreateNetworkWirelessSsidIdentityPskParams object
...
func (o *CreateNetworkWirelessSsidIdentityPskParams) WithDefaults() *CreateNetworkWirelessSsidIdentityPskParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CreateNetworkWirelessSsidIdentityPskParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the create network wireless ssid identity psk params
func (o *CreateNetworkWirelessSsidIdentityPskParams) WithTimeout(timeout time.Duration) *CreateNetworkWirelessSsidIdentityPskParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the create network wireless ssid identity psk params
func (o *CreateNetworkWirelessSsidIdentityPskParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the create network wireless ssid identity psk params
func (o *CreateNetworkWirelessSsidIdentityPskParams) WithContext(ctx context.Context) *CreateNetworkWirelessSsidIdentityPskParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the create network wireless ssid identity psk params
func (o *CreateNetworkWirelessSsidIdentityPskParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the create network wireless ssid identity psk params
func (o *CreateNetworkWirelessSsidIdentityPskParams) WithHTTPClient(client *http.Client) *CreateNetworkWirelessSsidIdentityPskParams {
...
func (o *CreateNetworkWirelessSsidIdentityPskParams) WithCreateNetworkWirelessSsidIdentityPsk(createNetworkWirelessSsidIdentityPsk CreateNetworkWirelessSsidIdentityPskBody) *CreateNetworkWirelessSsidIdentityPskParams {
	o.SetCreateNetworkWirelessSsidIdentityPsk(createNetworkWirelessSsidIdentityPsk)
	return o
}
...
func (o *CreateNetworkWirelessSsidIdentityPskParams) SetCreateNetworkWirelessSsidIdentityPsk(createNetworkWirelessSsidIdentityPsk CreateNetworkWirelessSsidIdentityPskBody) {
	o.CreateNetworkWirelessSsidIdentityPsk = createNetworkWirelessSsidIdentityPsk
}

// WithNetworkID adds the networkID to the create network wireless ssid identity psk params
func (o *CreateNetworkWirelessSsidIdentityPskParams) WithNetworkID(networkID string) *CreateNetworkWirelessSsidIdentityPskParams {
...
func (o *CreateNetworkWirelessSsidIdentityPskParams) WithNumber(number string) *CreateNetworkWirelessSsidIdentityPskParams {
	o.SetNumber(number)
	return o
}

// SetNumber adds the number to the create network wireless ssid identity psk params
func (o *CreateNetworkWirelessSsidIdentityPskParams) SetNumber(number string) {
	o.Number = number
}

// WriteToRequest writes these params to a swagger request
func (o *CreateNetworkWirelessSsidIdentityPskParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

	if err := r.SetTimeout(o.timeout); err != nil {
		return err
	}
	var res []error
	if err := r.SetBodyParam(o.CreateNetworkWirelessSsidIdentityPsk); err != nil {
		return err
	}
