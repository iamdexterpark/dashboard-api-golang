...
func (o *GetNetworkWirelessAirMarshalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkWirelessAirMarshalOK()
...
func NewGetNetworkWirelessAirMarshalOK() *GetNetworkWirelessAirMarshalOK {
	return &GetNetworkWirelessAirMarshalOK{}
}
...
func (o *GetNetworkWirelessAirMarshalOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/airMarshal][%d] getNetworkWirelessAirMarshalOK  %+v", 200, o.Payload)
}
func (o *GetNetworkWirelessAirMarshalOK) GetPayload() []interface{} {
	return o.Payload
}

func (o *GetNetworkWirelessAirMarshalOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
