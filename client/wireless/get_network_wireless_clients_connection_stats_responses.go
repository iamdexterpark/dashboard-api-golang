...
func (o *GetNetworkWirelessClientsConnectionStatsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkWirelessClientsConnectionStatsOK()
...
func NewGetNetworkWirelessClientsConnectionStatsOK() *GetNetworkWirelessClientsConnectionStatsOK {
	return &GetNetworkWirelessClientsConnectionStatsOK{}
}
...
func (o *GetNetworkWirelessClientsConnectionStatsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/clients/connectionStats][%d] getNetworkWirelessClientsConnectionStatsOK  %+v", 200, o.Payload)
}
func (o *GetNetworkWirelessClientsConnectionStatsOK) GetPayload() []interface{} {
	return o.Payload
}

func (o *GetNetworkWirelessClientsConnectionStatsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
