...
// NewGetNetworkWirelessSignalQualityHistoryParams creates a new GetNetworkWirelessSignalQualityHistoryParams object,
...
func NewGetNetworkWirelessSignalQualityHistoryParams() *GetNetworkWirelessSignalQualityHistoryParams {
	return &GetNetworkWirelessSignalQualityHistoryParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetNetworkWirelessSignalQualityHistoryParamsWithTimeout creates a new GetNetworkWirelessSignalQualityHistoryParams object
...
// NewGetNetworkWirelessSignalQualityHistoryParamsWithContext creates a new GetNetworkWirelessSignalQualityHistoryParams object
...
// NewGetNetworkWirelessSignalQualityHistoryParamsWithHTTPClient creates a new GetNetworkWirelessSignalQualityHistoryParams object
...
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithDefaults() *GetNetworkWirelessSignalQualityHistoryParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetNetworkWirelessSignalQualityHistoryParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithTimeout(timeout time.Duration) *GetNetworkWirelessSignalQualityHistoryParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithContext(ctx context.Context) *GetNetworkWirelessSignalQualityHistoryParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithHTTPClient(client *http.Client) *GetNetworkWirelessSignalQualityHistoryParams {
...
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithApTag(apTag *string) *GetNetworkWirelessSignalQualityHistoryParams {
	o.SetApTag(apTag)
	return o
}

// SetApTag adds the apTag to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) SetApTag(apTag *string) {
	o.ApTag = apTag
}

// WithAutoResolution adds the autoResolution to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithAutoResolution(autoResolution *bool) *GetNetworkWirelessSignalQualityHistoryParams {
...
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithBand(band *string) *GetNetworkWirelessSignalQualityHistoryParams {
	o.SetBand(band)
	return o
}

// SetBand adds the band to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) SetBand(band *string) {
	o.Band = band
}

// WithClientID adds the clientID to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithClientID(clientID *string) *GetNetworkWirelessSignalQualityHistoryParams {
...
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithDeviceSerial(deviceSerial *string) *GetNetworkWirelessSignalQualityHistoryParams {
...
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithNetworkID(networkID string) *GetNetworkWirelessSignalQualityHistoryParams {
...
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithResolution(resolution *int64) *GetNetworkWirelessSignalQualityHistoryParams {
...
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithSsid(ssid *int64) *GetNetworkWirelessSignalQualityHistoryParams {
	o.SetSsid(ssid)
	return o
}

// SetSsid adds the ssid to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) SetSsid(ssid *int64) {
	o.Ssid = ssid
}

// WithT0 adds the t0 to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithT0(t0 *string) *GetNetworkWirelessSignalQualityHistoryParams {
	o.SetT0(t0)
	return o
}

// SetT0 adds the t0 to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) SetT0(t0 *string) {
	o.T0 = t0
}

// WithT1 adds the t1 to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithT1(t1 *string) *GetNetworkWirelessSignalQualityHistoryParams {
	o.SetT1(t1)
	return o
}

// SetT1 adds the t1 to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) SetT1(t1 *string) {
	o.T1 = t1
}

// WithTimespan adds the timespan to the get network wireless signal quality history params
func (o *GetNetworkWirelessSignalQualityHistoryParams) WithTimespan(timespan *float32) *GetNetworkWirelessSignalQualityHistoryParams {
...
func (o *GetNetworkWirelessSignalQualityHistoryParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
