...
func (o *GetNetworkWirelessDataRateHistoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkWirelessDataRateHistoryOK()
...
func NewGetNetworkWirelessDataRateHistoryOK() *GetNetworkWirelessDataRateHistoryOK {
	return &GetNetworkWirelessDataRateHistoryOK{}
}
...
func (o *GetNetworkWirelessDataRateHistoryOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/wireless/dataRateHistory][%d] getNetworkWirelessDataRateHistoryOK  %+v", 200, o.Payload)
}
func (o *GetNetworkWirelessDataRateHistoryOK) GetPayload() []interface{} {
	return o.Payload
}

func (o *GetNetworkWirelessDataRateHistoryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
