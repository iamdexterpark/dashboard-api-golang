...
func (o *GetNetworkAlertsSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkAlertsSettingsOK()
...
func NewGetNetworkAlertsSettingsOK() *GetNetworkAlertsSettingsOK {
	return &GetNetworkAlertsSettingsOK{}
}
...
func (o *GetNetworkAlertsSettingsOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/alerts/settings][%d] getNetworkAlertsSettingsOK  %+v", 200, o.Payload)
}
func (o *GetNetworkAlertsSettingsOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkAlertsSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
