...
func (o *GetNetworkClientsOverviewReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkClientsOverviewOK()
...
func NewGetNetworkClientsOverviewOK() *GetNetworkClientsOverviewOK {
	return &GetNetworkClientsOverviewOK{}
}
...
func (o *GetNetworkClientsOverviewOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/clients/overview][%d] getNetworkClientsOverviewOK  %+v", 200, o.Payload)
}
func (o *GetNetworkClientsOverviewOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkClientsOverviewOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
