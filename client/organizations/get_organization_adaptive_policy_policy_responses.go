...
func (o *GetOrganizationAdaptivePolicyPolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetOrganizationAdaptivePolicyPolicyOK()
...
func (o *GetOrganizationAdaptivePolicyPolicyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
