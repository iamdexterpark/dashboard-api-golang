...
func (o *GetOrganizationConfigurationChangesParams) WithDefaults() *GetOrganizationConfigurationChangesParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetOrganizationConfigurationChangesParams) SetDefaults() {
...
func (o *GetOrganizationConfigurationChangesParams) WithPerPage(perPage *int64) *GetOrganizationConfigurationChangesParams {
...
func (o *GetOrganizationConfigurationChangesParams) WithTimespan(timespan *float32) *GetOrganizationConfigurationChangesParams {
