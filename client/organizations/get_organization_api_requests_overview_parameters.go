...
func (o *GetOrganizationAPIRequestsOverviewParams) WithDefaults() *GetOrganizationAPIRequestsOverviewParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetOrganizationAPIRequestsOverviewParams) SetDefaults() {
...
func (o *GetOrganizationAPIRequestsOverviewParams) WithTimespan(timespan *float32) *GetOrganizationAPIRequestsOverviewParams {
