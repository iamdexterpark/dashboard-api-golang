...
// NewGetOrganizationAdaptivePolicySettingsParams creates a new GetOrganizationAdaptivePolicySettingsParams object,
...
func NewGetOrganizationAdaptivePolicySettingsParams() *GetOrganizationAdaptivePolicySettingsParams {
	return &GetOrganizationAdaptivePolicySettingsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetOrganizationAdaptivePolicySettingsParamsWithTimeout creates a new GetOrganizationAdaptivePolicySettingsParams object
...
// NewGetOrganizationAdaptivePolicySettingsParamsWithContext creates a new GetOrganizationAdaptivePolicySettingsParams object
...
// NewGetOrganizationAdaptivePolicySettingsParamsWithHTTPClient creates a new GetOrganizationAdaptivePolicySettingsParams object
...
func (o *GetOrganizationAdaptivePolicySettingsParams) WithDefaults() *GetOrganizationAdaptivePolicySettingsParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetOrganizationAdaptivePolicySettingsParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get organization adaptive policy settings params
func (o *GetOrganizationAdaptivePolicySettingsParams) WithTimeout(timeout time.Duration) *GetOrganizationAdaptivePolicySettingsParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get organization adaptive policy settings params
func (o *GetOrganizationAdaptivePolicySettingsParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get organization adaptive policy settings params
func (o *GetOrganizationAdaptivePolicySettingsParams) WithContext(ctx context.Context) *GetOrganizationAdaptivePolicySettingsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get organization adaptive policy settings params
func (o *GetOrganizationAdaptivePolicySettingsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get organization adaptive policy settings params
func (o *GetOrganizationAdaptivePolicySettingsParams) WithHTTPClient(client *http.Client) *GetOrganizationAdaptivePolicySettingsParams {
...
func (o *GetOrganizationAdaptivePolicySettingsParams) WithOrganizationID(organizationID string) *GetOrganizationAdaptivePolicySettingsParams {
...
func (o *GetOrganizationAdaptivePolicySettingsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
