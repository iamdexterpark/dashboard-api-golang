...
// NewGetOrganizationInventoryDeviceParams creates a new GetOrganizationInventoryDeviceParams object,
...
func NewGetOrganizationInventoryDeviceParams() *GetOrganizationInventoryDeviceParams {
	return &GetOrganizationInventoryDeviceParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetOrganizationInventoryDeviceParamsWithTimeout creates a new GetOrganizationInventoryDeviceParams object
...
// NewGetOrganizationInventoryDeviceParamsWithContext creates a new GetOrganizationInventoryDeviceParams object
...
// NewGetOrganizationInventoryDeviceParamsWithHTTPClient creates a new GetOrganizationInventoryDeviceParams object
...
func (o *GetOrganizationInventoryDeviceParams) WithDefaults() *GetOrganizationInventoryDeviceParams {
	o.SetDefaults()
	return o
}
...
func (o *GetOrganizationInventoryDeviceParams) WithTimeout(timeout time.Duration) *GetOrganizationInventoryDeviceParams {
...
func (o *GetOrganizationInventoryDeviceParams) WithContext(ctx context.Context) *GetOrganizationInventoryDeviceParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get organization inventory device params
func (o *GetOrganizationInventoryDeviceParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get organization inventory device params
func (o *GetOrganizationInventoryDeviceParams) WithHTTPClient(client *http.Client) *GetOrganizationInventoryDeviceParams {
...
func (o *GetOrganizationInventoryDeviceParams) WithOrganizationID(organizationID string) *GetOrganizationInventoryDeviceParams {
...
func (o *GetOrganizationInventoryDeviceParams) WithSerial(serial string) *GetOrganizationInventoryDeviceParams {
	o.SetSerial(serial)
	return o
}
...
func (o *GetOrganizationInventoryDeviceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
