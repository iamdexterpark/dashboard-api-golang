...
// NewGetOrganizationSummaryTopClientsManufacturersByUsageParams creates a new GetOrganizationSummaryTopClientsManufacturersByUsageParams object,
...
func NewGetOrganizationSummaryTopClientsManufacturersByUsageParams() *GetOrganizationSummaryTopClientsManufacturersByUsageParams {
	return &GetOrganizationSummaryTopClientsManufacturersByUsageParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetOrganizationSummaryTopClientsManufacturersByUsageParamsWithTimeout creates a new GetOrganizationSummaryTopClientsManufacturersByUsageParams object
...
// NewGetOrganizationSummaryTopClientsManufacturersByUsageParamsWithContext creates a new GetOrganizationSummaryTopClientsManufacturersByUsageParams object
...
// NewGetOrganizationSummaryTopClientsManufacturersByUsageParamsWithHTTPClient creates a new GetOrganizationSummaryTopClientsManufacturersByUsageParams object
...
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) WithDefaults() *GetOrganizationSummaryTopClientsManufacturersByUsageParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get organization summary top clients manufacturers by usage params
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) WithTimeout(timeout time.Duration) *GetOrganizationSummaryTopClientsManufacturersByUsageParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get organization summary top clients manufacturers by usage params
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get organization summary top clients manufacturers by usage params
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) WithContext(ctx context.Context) *GetOrganizationSummaryTopClientsManufacturersByUsageParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get organization summary top clients manufacturers by usage params
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get organization summary top clients manufacturers by usage params
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) WithHTTPClient(client *http.Client) *GetOrganizationSummaryTopClientsManufacturersByUsageParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get organization summary top clients manufacturers by usage params
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithOrganizationID adds the organizationID to the get organization summary top clients manufacturers by usage params
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) WithOrganizationID(organizationID string) *GetOrganizationSummaryTopClientsManufacturersByUsageParams {
...
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) WithT0(t0 *string) *GetOrganizationSummaryTopClientsManufacturersByUsageParams {
	o.SetT0(t0)
	return o
}

// SetT0 adds the t0 to the get organization summary top clients manufacturers by usage params
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) SetT0(t0 *string) {
	o.T0 = t0
}

// WithT1 adds the t1 to the get organization summary top clients manufacturers by usage params
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) WithT1(t1 *string) *GetOrganizationSummaryTopClientsManufacturersByUsageParams {
	o.SetT1(t1)
	return o
}

// SetT1 adds the t1 to the get organization summary top clients manufacturers by usage params
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) SetT1(t1 *string) {
	o.T1 = t1
}

// WithTimespan adds the timespan to the get organization summary top clients manufacturers by usage params
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) WithTimespan(timespan *float32) *GetOrganizationSummaryTopClientsManufacturersByUsageParams {
...
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) SetTimespan(timespan *float32) {
	o.Timespan = timespan
}

// WriteToRequest writes these params to a swagger request
func (o *GetOrganizationSummaryTopClientsManufacturersByUsageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
