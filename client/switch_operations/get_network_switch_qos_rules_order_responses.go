...
func (o *GetNetworkSwitchQosRulesOrderReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkSwitchQosRulesOrderOK()
...
func NewGetNetworkSwitchQosRulesOrderOK() *GetNetworkSwitchQosRulesOrderOK {
	return &GetNetworkSwitchQosRulesOrderOK{}
}
...
func (o *GetNetworkSwitchQosRulesOrderOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/switch/qosRules/order][%d] getNetworkSwitchQosRulesOrderOK  %+v", 200, o.Payload)
}
func (o *GetNetworkSwitchQosRulesOrderOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkSwitchQosRulesOrderOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
