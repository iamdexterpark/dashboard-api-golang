...
// NewGetNetworkSwitchPortSchedulesParams creates a new GetNetworkSwitchPortSchedulesParams object,
...
func NewGetNetworkSwitchPortSchedulesParams() *GetNetworkSwitchPortSchedulesParams {
	return &GetNetworkSwitchPortSchedulesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetNetworkSwitchPortSchedulesParamsWithTimeout creates a new GetNetworkSwitchPortSchedulesParams object
...
// NewGetNetworkSwitchPortSchedulesParamsWithContext creates a new GetNetworkSwitchPortSchedulesParams object
...
// NewGetNetworkSwitchPortSchedulesParamsWithHTTPClient creates a new GetNetworkSwitchPortSchedulesParams object
...
func (o *GetNetworkSwitchPortSchedulesParams) WithDefaults() *GetNetworkSwitchPortSchedulesParams {
	o.SetDefaults()
	return o
}
...
func (o *GetNetworkSwitchPortSchedulesParams) WithTimeout(timeout time.Duration) *GetNetworkSwitchPortSchedulesParams {
...
func (o *GetNetworkSwitchPortSchedulesParams) WithContext(ctx context.Context) *GetNetworkSwitchPortSchedulesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get network switch port schedules params
func (o *GetNetworkSwitchPortSchedulesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get network switch port schedules params
func (o *GetNetworkSwitchPortSchedulesParams) WithHTTPClient(client *http.Client) *GetNetworkSwitchPortSchedulesParams {
...
func (o *GetNetworkSwitchPortSchedulesParams) WithNetworkID(networkID string) *GetNetworkSwitchPortSchedulesParams {
...
func (o *GetNetworkSwitchPortSchedulesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
