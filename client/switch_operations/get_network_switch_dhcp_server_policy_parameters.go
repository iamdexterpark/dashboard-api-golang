...
// NewGetNetworkSwitchDhcpServerPolicyParams creates a new GetNetworkSwitchDhcpServerPolicyParams object,
...
func NewGetNetworkSwitchDhcpServerPolicyParams() *GetNetworkSwitchDhcpServerPolicyParams {
	return &GetNetworkSwitchDhcpServerPolicyParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetNetworkSwitchDhcpServerPolicyParamsWithTimeout creates a new GetNetworkSwitchDhcpServerPolicyParams object
...
// NewGetNetworkSwitchDhcpServerPolicyParamsWithContext creates a new GetNetworkSwitchDhcpServerPolicyParams object
...
// NewGetNetworkSwitchDhcpServerPolicyParamsWithHTTPClient creates a new GetNetworkSwitchDhcpServerPolicyParams object
...
func (o *GetNetworkSwitchDhcpServerPolicyParams) WithDefaults() *GetNetworkSwitchDhcpServerPolicyParams {
	o.SetDefaults()
	return o
}
...
func (o *GetNetworkSwitchDhcpServerPolicyParams) WithTimeout(timeout time.Duration) *GetNetworkSwitchDhcpServerPolicyParams {
...
func (o *GetNetworkSwitchDhcpServerPolicyParams) WithContext(ctx context.Context) *GetNetworkSwitchDhcpServerPolicyParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get network switch dhcp server policy params
func (o *GetNetworkSwitchDhcpServerPolicyParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get network switch dhcp server policy params
func (o *GetNetworkSwitchDhcpServerPolicyParams) WithHTTPClient(client *http.Client) *GetNetworkSwitchDhcpServerPolicyParams {
...
func (o *GetNetworkSwitchDhcpServerPolicyParams) WithNetworkID(networkID string) *GetNetworkSwitchDhcpServerPolicyParams {
...
func (o *GetNetworkSwitchDhcpServerPolicyParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
