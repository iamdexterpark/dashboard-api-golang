...
func (o *GetNetworkSwitchStackRoutingInterfaceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkSwitchStackRoutingInterfaceOK()
...
func NewGetNetworkSwitchStackRoutingInterfaceOK() *GetNetworkSwitchStackRoutingInterfaceOK {
	return &GetNetworkSwitchStackRoutingInterfaceOK{}
}
...
func (o *GetNetworkSwitchStackRoutingInterfaceOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/switch/stacks/{switchStackId}/routing/interfaces/{interfaceId}][%d] getNetworkSwitchStackRoutingInterfaceOK  %+v", 200, o.Payload)
}
func (o *GetNetworkSwitchStackRoutingInterfaceOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetNetworkSwitchStackRoutingInterfaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
