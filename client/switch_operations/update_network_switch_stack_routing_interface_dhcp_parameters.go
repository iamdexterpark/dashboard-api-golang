...
// NewUpdateNetworkSwitchStackRoutingInterfaceDhcpParams creates a new UpdateNetworkSwitchStackRoutingInterfaceDhcpParams object,
...
func NewUpdateNetworkSwitchStackRoutingInterfaceDhcpParams() *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams {
	return &UpdateNetworkSwitchStackRoutingInterfaceDhcpParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateNetworkSwitchStackRoutingInterfaceDhcpParamsWithTimeout creates a new UpdateNetworkSwitchStackRoutingInterfaceDhcpParams object
...
// NewUpdateNetworkSwitchStackRoutingInterfaceDhcpParamsWithContext creates a new UpdateNetworkSwitchStackRoutingInterfaceDhcpParams object
...
// NewUpdateNetworkSwitchStackRoutingInterfaceDhcpParamsWithHTTPClient creates a new UpdateNetworkSwitchStackRoutingInterfaceDhcpParams object
...
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) WithDefaults() *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the update network switch stack routing interface dhcp params
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) WithTimeout(timeout time.Duration) *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the update network switch stack routing interface dhcp params
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the update network switch stack routing interface dhcp params
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) WithContext(ctx context.Context) *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the update network switch stack routing interface dhcp params
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the update network switch stack routing interface dhcp params
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) WithHTTPClient(client *http.Client) *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the update network switch stack routing interface dhcp params
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithInterfaceID adds the interfaceID to the update network switch stack routing interface dhcp params
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) WithInterfaceID(interfaceID string) *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams {
...
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) WithNetworkID(networkID string) *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams {
	o.SetNetworkID(networkID)
	return o
}

// SetNetworkID adds the networkId to the update network switch stack routing interface dhcp params
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) SetNetworkID(networkID string) {
	o.NetworkID = networkID
}

// WithSwitchStackID adds the switchStackID to the update network switch stack routing interface dhcp params
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) WithSwitchStackID(switchStackID string) *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams {
...
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) WithUpdateNetworkSwitchStackRoutingInterfaceDhcp(updateNetworkSwitchStackRoutingInterfaceDhcp UpdateNetworkSwitchStackRoutingInterfaceDhcpBody) *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams {
	o.SetUpdateNetworkSwitchStackRoutingInterfaceDhcp(updateNetworkSwitchStackRoutingInterfaceDhcp)
	return o
}
...
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) SetUpdateNetworkSwitchStackRoutingInterfaceDhcp(updateNetworkSwitchStackRoutingInterfaceDhcp UpdateNetworkSwitchStackRoutingInterfaceDhcpBody) {
	o.UpdateNetworkSwitchStackRoutingInterfaceDhcp = updateNetworkSwitchStackRoutingInterfaceDhcp
}

// WriteToRequest writes these params to a swagger request
func (o *UpdateNetworkSwitchStackRoutingInterfaceDhcpParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if err := r.SetBodyParam(o.UpdateNetworkSwitchStackRoutingInterfaceDhcp); err != nil {
		return err
	}
