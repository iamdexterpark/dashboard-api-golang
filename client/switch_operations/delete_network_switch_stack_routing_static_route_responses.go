...
func (o *DeleteNetworkSwitchStackRoutingStaticRouteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeleteNetworkSwitchStackRoutingStaticRouteNoContent()
...
func NewDeleteNetworkSwitchStackRoutingStaticRouteNoContent() *DeleteNetworkSwitchStackRoutingStaticRouteNoContent {
	return &DeleteNetworkSwitchStackRoutingStaticRouteNoContent{}
}
...
func (o *DeleteNetworkSwitchStackRoutingStaticRouteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /networks/{networkId}/switch/stacks/{switchStackId}/routing/staticRoutes/{staticRouteId}][%d] deleteNetworkSwitchStackRoutingStaticRouteNoContent ", 204)
}

func (o *DeleteNetworkSwitchStackRoutingStaticRouteNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
