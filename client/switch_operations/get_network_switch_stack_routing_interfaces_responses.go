...
func (o *GetNetworkSwitchStackRoutingInterfacesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetNetworkSwitchStackRoutingInterfacesOK()
...
func NewGetNetworkSwitchStackRoutingInterfacesOK() *GetNetworkSwitchStackRoutingInterfacesOK {
	return &GetNetworkSwitchStackRoutingInterfacesOK{}
}
...
func (o *GetNetworkSwitchStackRoutingInterfacesOK) Error() string {
	return fmt.Sprintf("[GET /networks/{networkId}/switch/stacks/{switchStackId}/routing/interfaces][%d] getNetworkSwitchStackRoutingInterfacesOK  %+v", 200, o.Payload)
}
func (o *GetNetworkSwitchStackRoutingInterfacesOK) GetPayload() []interface{} {
	return o.Payload
}

func (o *GetNetworkSwitchStackRoutingInterfacesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
