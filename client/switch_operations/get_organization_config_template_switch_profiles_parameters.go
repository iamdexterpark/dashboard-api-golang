...
func (o *GetOrganizationConfigTemplateSwitchProfilesParams) WithDefaults() *GetOrganizationConfigTemplateSwitchProfilesParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetOrganizationConfigTemplateSwitchProfilesParams) SetDefaults() {
